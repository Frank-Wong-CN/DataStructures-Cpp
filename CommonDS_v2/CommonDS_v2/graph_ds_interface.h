...
void CommonDS_v2_Graph_ConnectVertex(CommonDS_v2_List_ElementType X1, CommonDS_v2_List_ElementType X2, CommonDS_v2_AdjacencyList_ExtraDataType N, CommonDS_v2_Graph G, int Directed);
